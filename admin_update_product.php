...
if(isset($_POST['update_product'])){
   ...
   $expired_day = mysqli_real_escape_string($conn, $_POST['expired_day']);

   mysqli_query($conn, "UPDATE `products` SET name = '$name', details = '$details', price = '$price', expired_day = '$expired_day'  WHERE id = '$update_p_id'") or die('query failed');
...
<form action="" method="post" enctype="multipart/form-data">
   ...
   <input type="number" min="0" class="box" value="<?php echo $fetch_products['expired_day']; ?>" required placeholder="update product expired day" name="expired_day">
